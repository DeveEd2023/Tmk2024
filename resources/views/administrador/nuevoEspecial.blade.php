...
@section('content')
    ...
    <h3 style="font-family: Franklin Gothic; text-align: center"> <i class="bx bxs-user-plus"></i> Nuevo profesor Especial
    </h3>
    ...
    <div class="container">
        ...
        <form id="userForm" action="{{ url('admin/crearEspecial') }}" method="POST">
            @csrf
            ...
            <div class="col-md-12">
                ...
                <div class="form-group">
                    <label for="materia">
                        <i class="ri-edit-box-line"></i> Materia
                    </label><br>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            gradoSelect.addEventListener('change', function() {
                ...
                fetch(`/admin/cargarMateria/${materiaId}`)
                    .then(response => response.json())
                    .then(data => {
                        ...
                        data.forEach(item => {
                            ...
                            option.textContent = item.materia;

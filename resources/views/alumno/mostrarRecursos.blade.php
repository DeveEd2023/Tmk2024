...
@endsection
@section('content')
    <h3 style="font-family: Franklin Gothic; text-align: center"> <i class="ri-book-read-line"></i> Libreta digital</h3>
                                        ...
                                        <div class="col-md-2">
                                            <li style="list-style: none;">
                                                ...
                                                <div class="mailbox-attachment-info"
                                                    ...
                                                    <a href="{{ url('/alumno/ver/' . $archivo->id . '/' . $archivo->grado_id . '/' . $archivo->materia_id . '/' . $archivo->archivo) }}"

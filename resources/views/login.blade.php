...
<head>
    ...
    <style>
        body {
            background-image: url('public/img/imgK.webp');
...
<body style="background-image: url('public/img/imgK.webp');  ">
    ...
    <main>
        ...
        <div class="d-flex justify-content-center align-items-center" style="height:80vh;">
            ...
            <div class="card shadow"
                ...
                <img src="{{ asset('public/img/icono.png') }}" alt="" class="mx-auto d-block"
